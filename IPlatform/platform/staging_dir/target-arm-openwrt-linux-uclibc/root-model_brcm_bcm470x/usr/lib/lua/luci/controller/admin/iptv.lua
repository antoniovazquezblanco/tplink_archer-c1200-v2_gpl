...
local function uci_get()
	...
	if data.mode == "MEO" then
               if data.lan1 == "Internet" then
                       data.lan1 = "Internet-IPTV"
               end
               if data.lan2 == "Internet" then
                       data.lan2 = "Internet-IPTV"
               end
               if data.lan3 == "Internet" then
                       data.lan3 = "Internet-IPTV"
               end
               data.lan4 = "Bridge"               
    end
    return data
...
local function check(data)
    ...
    if data.mode ~= "Bridge" and data.mode ~= "Custom"
        and data.mode ~= "Russia" and data.mode ~= "Maxis"       
            and data.mode ~= "ExStream" and data.mode ~= "Unifi"		and data.mode ~= "MEO" and data.mode ~= "VDF"
    then
        return false
    end
    ...
    local flag 
    if data.mode == "Custom" or data.mode == "Russia" or data.mode == "Maxis" or data.mode == "MEO" or data.mode == "VDF"
    then
        flag = true
    else
        flag = false
...
local function parse_url(formvalue)
	...
	elseif iptv_new.mode == "MEO" then
		...
		iptv_new.lan1 =  "Internet"
		iptv_new.lan2 =  "Internet"
		iptv_new.lan3 =  "Internet"
