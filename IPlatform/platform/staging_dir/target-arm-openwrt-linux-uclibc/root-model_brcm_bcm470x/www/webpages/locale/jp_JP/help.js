	...
	$.su.CHAR.HELP = {
				...
				},
				{
					...
					children: [
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "– ご契約のISPがPortugal-MEOの場合はこちらを選択してください。そして、インターネットVLAN IDとプライオリティそしてLAN(1/2/3/4)ポート機能を含む所定のパラメーターを入力していただく必要がございます。"
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "– ご契約のISPがPortugal-Vodafoneの場合はこちらを選択してください。そして、インターネット/IP電話/IPTV VLAN IDのプライオリティを含む所定のパラメーターを入力していただく必要がございます。また、必要に応じて各LANポートに機能を指定することが可能です(インターネットサプライヤー/IPTVサプライヤー/IP電話サプライヤー/インターネットIPTVサプライヤー)。"
						},
						{
							type: "name",
							title: "カスタム",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "アドレス リース時間",
				content: "IP アドレスをクライアントにリースする時間を 1 ～ 2880 分で入力します。既定値は 120 分です。"
			},{
				type: "name",
				title: "デフォルト ゲートウェイ",
		...
		DDNS: {
			...
			CONTENT: [{
				...
				content: [
					...
					"5. NO-IPをご使用の場合はWAN IPバインディングを選択し、ドメイン名がこのルーターのWAN IPであることを確認します。",
					"6.[ログイン]、[保存] をクリックします。"
				]
			},{
				type: "note",
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "ルーターのファームウェアをアップグレードする前に、<a class=\"link\" href=\"http://www.tp-link.com/jp/Support/\" target=\"_blank\">TP-Link サポート</a> ウェブサイトからコンピューターに最新のファームウェア アップデートをダウンロードする必要があります。"
			},{
				type: "step",
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX ビームフォーミングは、指向性信号送信用センサーアレイに使用される信号処理技術です。 有効になっている場合、Wi-Fi信号の強化とWi-Fiの到達範囲拡張に利用されます。"
			},{
				type: "name",
