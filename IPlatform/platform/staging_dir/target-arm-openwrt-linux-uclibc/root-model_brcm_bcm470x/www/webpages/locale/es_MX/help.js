	...
	$.su.CHAR.HELP = {
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Modo",
					content: "Seleccionar el modo adecuado de acuerdo a su ISP.",
					children: [
						{
							type: "name",
							title: "Puente",
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "Seleccione si su ISP es Portugal-MEO y es necesario que los parametros esten predeterminados, incluyendo el ID de la VLAN de Internet y la prioridad; con las características de los puertos LAN (1/2/3/4)."
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "Seleccione si su ISP es Portugal-Vodafone, los parametros necesarios están predeterminados, incluyendo Internet / IP-Teléfono / IPTV IDs de VLAN y la prioridad. Puede reasignar a sus puertos LAN las funciones, respectivamente, según sea necesario (servicios de Internet / servicio de IPTV / servicio de IP Telefono / servicio de IPTV)."
						},
						{
							type: "name",
							title: "Personalizado",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Ingresar la duración de tiempo que una dirección IP puede ser arrendada al cliente entre 1 y 2880 minutos. El valor predeterminado es 120 minutos"
			},{
				type: "name",
				title: "Puerta de Enlace Predeterminada",
		...
		DDNS: {
			...
			CONTENT: [{
				...
				content: [
					"1. Seleccione su proveedor de servicios de DNS Dinámico.",
					...
					"5. Si su proveedor de servicio es NO-IP, seleccione enlazar con WAN IP para asegurar que el nombre del dominio se enlaza a la WAN IP del router. ",
					"6. Haga clic en Iniciar Sesión y Guardar."
				]
			},{
				type: "note",
				title:"Nota",
		...
		WIRELESS_STATISTICS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Tipo de Conexión",
				content: "Muestra la frecuencia de banda inalámbrica (2.4GHz/5GHz) de los clientes inalámbricos asociados."
			},{
				type: "name",
				title: "Seguridad",
		...
		ADMIN_ACCOUNT: {	
			...
			CONTENT: [{
				...
				content: "Escribir su nombre de usuario nuevo."
			},{
				type: "name",
				...
				type: "note",
				title: "Nota",
				content: "Si decide cambiar el nombre de usuario y contraseña actual usados para iniciar sesión en el router, asegúrese de escribir la información nueva de inicio de sesión en un lugar seguro.  "
			},{
				type: "paragraph",
				content: "Dar clic en Guardar para guardar todas sus configuraciones"
			}]
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX Beamforming es una técnica de procesamiento de señales utilizado en arreglos de sensores para la transmisión de señal direccional. Si está activado, se va a utilizar en el extremo del transmisor con el fin de reforzar la señal Wi-Fi y ampliar la cobertura Wi-Fi."
			},{
				type: "name",
		...
		OPEN_VPN_CERTIFICATE:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Usar el certificado para la información e identificación de la conexión de VPN para clientes remotos."
			},{
				type: "name",
				title: "Generar",
				content: "Dar clic para generar un certificado nuevo."
			}]
		},
		OPEN_VPN_CONF:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Los clientes remotos usarán el archivo de configuración para tener acceso a su router."
			},{
				type: "name",
				title: "Exportar",
				content: "Dar clic para guardar el archivo de configuración de VPN Abierto."
			}]
		},
		OPEN_VPN_GUIDE:{
			...
			CONTENT: [{
				...
				content:[{
					type: "paragraph",
					content: "Antes de configurar el servidor de VPN abierto, por favor configure el Servicio de DNS Dinámico (recomendado) o asigne una dirección IP estática para el puerto WAN. Y asegúrese que su puerto externo de las configuraciones de NAT no sea el puerto de servicio, y que su Tiempo del Sistema esté sincronizado con Internet."
				},
		...
		BASIC_GUEST_NETWORK: {
			...
			CONTENT:[{
				type:"paragraph",
				content:"El servicio de la nube TP-Link le permite monitorear remotamente su red en tiempo real, así como acceder y administrar los dispositivos TP-Link usando Internet desde cualquier lugar y en cualquier momento."
			}]
		},
		ACCOUNT_INFO:{
		...
		BOUND_ACCOUNT:{
			...
			CONTENT:[{
				...
				content:["1. Haga clic en Enlazar.",
