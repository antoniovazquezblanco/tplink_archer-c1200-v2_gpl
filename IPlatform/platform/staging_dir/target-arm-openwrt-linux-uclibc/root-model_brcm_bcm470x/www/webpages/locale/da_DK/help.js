	...
	$.su.CHAR.HELP = {
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Tilstand",
					content: "Vælg den ønskede tilstand som anbefalet af din internetudbyder.",
					children: [
						{
							type: "name",
							title: "Bro",
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "Vælg, om din internetudbyder er Portugal-MEO og de nødvendige parametre er forudbestemt, herunder Internet VLAN ID og prioritet, og LAN (1/2/3/4) portfunktioner."
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "Vælg, om din internetudbyder er Portugal-Vodafone og de nødvendige parametre er forudbestemt, herunder Internet/IP-telefon/IPTV VLAN-id'er og prioritet. Du kan overflytte dine LAN-porte til deres funktioner, som nødvendigt (Internetudbyder/udbyder af IPTV/udbyder af IP-telefon/udbyder af Internet-IPTV)."
						},
						{
							type: "name",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Angiv den tid, som en IP-adresse er leaset til klienten mellem 1 og 2880 minutter. Standardværdien er 120 minutter."
			},{
				type: "name",
				title: "Standard gateway",
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Dynamisk DNS (Domain Name System) giver dig mulighed for at tildele et fast host- og domænenavn til en dynamisk internet-IP-adresse. Det er nyttigt hvis du hoster dit eget websted, FTP-server eller en anden server bagved routeren. Først skal du tilmelde dig en Dynamisk DNS-tjenesteudbyder, som f. eks. www.dyndns.com. Indtast derefter dine registreringsoplysninger."
			},{
				type: "step",
				...
				content: [
					...
					"3. Indtast det domænenavn, du registrerede med den dynamiske DNS-tjenesteudbyder.",
					"4. Vælge det tidsinterval, hvor den dynamiske DNS-opdateringsforespørgsel skal sendes.",
					"5. Hvis din internetudbyder er NO-IP, skal du vælge WAN IP Binding for at sikre at domænenavnet er bundet til routerens WAN IP.",
		...
		DOMAIN_NAME_LIST: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Denne tabel viser de dynamiske DNS-domænenavne, der er registreret til din TP-Link ID."
			},{
				type:"step",
				title: "Sådan registreres et nyt domænenavn",
				content: [
					"1. Klik på Register (Registrer).",
					"2. Indtast domænenavnet.",
					"3. Klik på Gem."
					]
			}]
		},
		...
		WIRELESS_24G: {	
			...
			CONTENT: [{
				...
				content: "Marker dette afkrydsningsfelt for at aktivere den trådløse 2,4 GHz radiofrekvens."
			},{
				type: "name",
				title: "SSID (Navn på trådløst netværk)",
				...
				type: "name",
				title: "Skjul SSID",
				content: "Marker dette afkrydsningsfelt, hvis du vil skjule 2.4GHz netværksnavnet (SSID) fra listen over trådløse netværk."
			},{
				type: "name",
				title: "Sikkerhed",
				...
				children: [{
					...
					children: [{
						...
						children: [{
							...
							type: "name",
							title: "WPA-PSK",
							content: "Denne funktion understøtter kun TKIP-kryptering, hvilket giver et godt niveau af sikkerhed."
						},{
							type: "name",
							title: "WPA2-PSK",
					...
					type: "name",
					title: "WEP",
					content: "Vælg denne indstilling for at aktivere en grundlæggende godkendelsesmetode, hvis nogen af dine klientenheder kun kan få adgang til trådløs brug af WEP (Wired Equivalent Privacy).",
					children: [{
						type: "name",
						title: "Type",
		...
		WIRELESS_5G: {	
			...
			CONTENT: [{
				type: "name",
				title: "Aktiver trådløs radio",
				content: "Marker dette afkrydsningsfelt for at aktivere den trådløse 5GHz radiofrekvens."
			},{
				type: "name",
				title: "SSID (Navn på trådløst netværk)",
				content: "Du kan lade standard netværksnavnet (SSID) være som det er, eller indtast et nyt navn (op til 32 tegn). Dette felter skelner mellem store og små bogstaver."
				...
				type: "name",
				title: "Skjul SSID",
				content: "Marker dette afkrydsningsfelt, hvis du vil skjule 5GHz netværksnavnet (SSID) fra listen over trådløse netværk."
			},{
				type: "name",
				title: "Sikkerhed",
				content: "Vælg én af følgende sikkerhedsfunktioner:",
		...
		FOLDER_SHARE_ACCOUNT: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Brugernavn/adgangskode",
				content: "Angiv en alfanumerisk eller understreget streng på op til 15 tegn. Brugernavnet skal begynde med et bogstav. Disse felter skelner mellem store og små bogstaver."
			},{
				type: "name",
		...
		PARENTAL_CONTROL: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Forældrekontrol",
				content: "Aktiver for at aktivere funktionen Forældrekontrol."
			}]
		},
		...
		PARENTAL_CONTROL_RESTRICTION: {
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Søgeord kan også være domænenavne, f. eks. www.mail.google.com eller www.facebook.com."
			}]
		},
		...
		ACCESS_DEVICE: {
			...
			CONTENT: [{
				...
				content: "Vælg alle de enheder, som du ønsker at blokere i tabellen over onlineenheder og klik på Blokker over tabellen. Enheden vil automatisk blive tilføjet til sortlistede eller hvidlistede enheder."
			}],
		},
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "Før du udfører firmware-opgradering af routeren, skal du downloade den seneste firmwareopdatering fra <a class=\"link\" target=\"_blank\" href=\"http://www.tp-link.com/dk/Support/\">TP-Link Support</a> hjemmesiden til din computer."
			},{
				type: "step",
		...
		ADMIN_REMOTE: {	
			...
			CONTENT: [{
				...
				content: "Indtast en gyldig IP-adresse eller IP interval for at kunne få adgang til routeren."
			},{
				type: "paragraph",
				content: "Klik på Gem for at gemme alle dine indstillingerne."
			}]
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX Beamforming er en signalbehandlingsteknik, der anvendes i sensor antennegrupper til retningsbestemt signaltransmission. Hvis aktiveret, vil det blive brugt i den transmitterende ende for at styrke Wi-Fi-signalet og udvide Wi-Fi-dækningen."
			},{
				type: "name",
		...
		PPTP_VPN_GUIDE:{
			...
			CONTENT: [{
				...
				content:[{
					...
					"4. Start PPTP VPN-programmet, tilføje en ny forbindelse og indtast domænenavnet på den registrerede DDNS-tjeneste eller den statiske IP-adresse, som er tildelt WAN-porten, for at tilslutte enheden til PPTP VPN-serveren."
				]}
			]
		},
		VPN_CONNNECTION:{
		...
		BASIC_NETWORK_ROUTER: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "SSID",
				content: "Viser det aktuelle trådløse netværksnavn på 2,4 GHz/ 5GHz frekvensen."
			},{
				type: "name",
				title: "Kanal",
		...
		BASIC_WIRELESS: {
			...
			CONTENT: [{
				type: "name",
				title: "Aktiver trådløs radio",
				content: "Marker dette afkrydsningsfelt for at aktivere den trådløse 2,4 GHz/5GHZ radiofrekvens."
			},{
				type: "name",
				title: "SSID (Navn på trådløst netværk)",
