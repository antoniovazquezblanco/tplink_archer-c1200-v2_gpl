(function($){
	...
	$.su.CHAR = {
		LOGIN: {
			...
			FIRST_TIME: 				"Please set up your %PRODUCT% to connect to the Internet first. To begin, create a device password to manage your %PRODUCT%.",
			FIRST_TIME1: 				"Please create an administrator password to manage your %model%.",
		...
		UPGRADE: {
			...
			NOTICE:    						"Hi, a new firmware is available for your router.",
		...
		VTYPETEXT: {
			...
			NAME_SPECIAL: 				"Please enter 4-15 alpha characters, numbers, - and _.",
		...
		PRINT:{
			...
			NOTE3: 						"Install the TP-Link USB Printer Controller Utility. Please download it from our official website: <a class=\"link\" href=\"%SUPPORT%\" target=\"_blank\">%SUPPORT%</a>."
		},
