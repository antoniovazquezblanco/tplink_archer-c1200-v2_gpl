	...
	$.su.CHAR.HELP = {
		...
		STATUS_WIRELESS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Canal",
				content: "N° du canal Wi-Fi et la fréquence (GHz) correspondante."
			},{
				type: "name",
				title: "Adresse MAC",
				content: "Adresse physique unique attribuée au port WAN du routeur."
		...
		INTERNET_INTERNET: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Utiliser les adresse DNS suivantes",
				...
				children: [{
					type: "note",
					title: "Remarque",
					content: "Dans de très rares cas, votre FAI peut vous indiquer de modifier la valeur du MTU afin d'optimiser les performances de votre accès, à l'exception de ces cas ne pas modifier le MTU."
				}]
			},{
				type: "name",
				...
				type: "name",
				title: "Détecter l'intervalle en ligne",
				...
				content: "Si votre FAI vous demande de renseigner des adresses DNS, saisir celles ci après avoir choisi Utiliser les adresses DNS suivantes et compléter les champs DNS Primaire et DNS Secondaire sinon choisir Obtenir les adresses automatiquement pour que votre connexion se voit attribuer les adresses DNS automatiquement."
			},{
				type: "name",
		...
		INTERNET_MAC: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Utiliser une autre adresse MAC",
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Mode",
					content: "Choisir le mode approprié en fonction de votre FAI.",
					children: [
						{
							type: "name",
							title: "Pont",
						...
						},
						{
							type: "name",
							title: "Russie",
							content: "Sélectionnez-la si votre FAI est Russe et les paramètres nécessaires seront prédéterminés y compris : Internet/IP-Phone/ID et priorité d'IPTV et de VLAN, ainsi que les caractéristiques des ports LAN (1/2/3/4).",
							children: [{
								type: "name",
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "Sélectionner si votre FAI est Portugal-MEO et que les paramètres adéquats sont prédéfinis, ce qui inclue Priorité et ID de VLAN Internet, et fonctionnalités des ports LAN (1/2/3/4)."
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "Sélectionner si votre FAI est MEO-Portugal - et que les paramètres adéquats sont prédéfinis, ce qui inclue Priorité et ID de VLAN Internet/Téléphonie IP/TV IP. Vous pouvez réassigner les ports LAN en fonction des fonctionnalités requises (Fournisseurs :Internet/Téléphonie IP/TV IP)."
						},
						{
							type: "name",
							title: "Autre",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Adresse IP Plage",
				content: "Saisir l'étendue des adresses IP qui seront attribuées aux clients."
			},{
				type: "name",
				title: "Durée du bail",
				content: "Saisir la durée du bail attribuée au client (1 à 2880 minutes) la valeur par défaut étant 120 minutes."
			},{
				type: "name",
				title: "Passerelle par défaut",
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Les DNS Dynamiques (Domain Name System) vous permettent d'assigner un hôte statique et un nom de domaine à une adresse IP internet dynamique. C'est utile quand vous hébergez votre propre site WEB, un serveur FTP, ou tout serveur placé derrière votre routeur. Pour commencer vous devez vous abonner à un fournisseur de service de DNS dynamique tel www.dyn.com. Puis, saisir vos informations d'enregistrement."
			},{
				type: "step",
				...
				content: [
					...
					"3. Saisir le nom de domaine que vous avez enregistré auprès du fournisseur de service de DNS Dynamique.",
					"4. Choisir l'intervalle de temps entre chaque requête de mise à jour du DNS Dynamique.",
					"5. Si votre fournisseur de service est NO-IP, choisir d'associer l'IP WAN pour garantir que le nom de domaine est associé à l'IP WAN de ce routeur.",
					"6. Cliquer sur Se connecter et Sauvegarder"
				]
			},{
				type: "note",
				title:"Remarque",
				content: "Si vous souhaitez utiliser un nouveau compte DDNS, merci de vous déconnecter du compte actif avant de vous connecter à votre nouveau compte."
			}]
		},
                DYNAMIC_DNS: {
			TITLE: "DNS Dynamique",
		...
		DOMAIN_NAME_LIST: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Cette liste affiche les noms de domaine de DNS dynamique associés à votre identifiant TP-Link"
			},{
				type:"step",
		...
		WIRELESS_24G: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Masquer le SSID",
				content: "Cocher cette case si vous décidez que le nom du réseau Wi-Fi 2.4GHz ne doit pas apparaitre dans la liste des réseaux disponibles."
			},{
				type: "name",
				title: "Sécurité",
				...
				children: [{
					...
					children: [{
						...
						type: "name",
						title: "Chiffrement",
						content: "Choisir un type de chiffrement : TKIP (Temporal Key Integrity Protocol), AES (Advanced Encryption Standard), ou Auto (support de TKIP et AES). Il n'est pas recommandé d'utiliser le chiffrement TKIP en Wi-Fi 802.11n, car TKIP n'est pas supporté dans les spécifications 802.11n. Si TKIP est sélectionné la fonction WPS sera désactivée."
					},{
						type: "name",
						title: "Mot de passe",
		...
		WIRELESS_5G: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Masquer le SSID",
				content: "Cocher cette case si vous décidez que le nom du réseau Wi-Fi ne doit pas apparaitre dans la liste des réseaux disponibles."
			},{
				type: "name",
				title: "Sécurité",
				content: "Choisir l'une des options de sécurité suivantes :",
		...
		GUEST_NETWORK_WIRELESS:{	
			TITLE: "Réseau sans fil 2,4GHz/5GHz",
			CONTENT: [{
				type: "name",
				title: "Activer Réseau invités",
		...
		NAT: {
			TITLE: "Passerelle applicative (Application Layer Gateway : ALG)",
			CONTENT: [{
				type: "paragraph",
				...
				type: "name",
				title: "Activer PPTP Passthrough",
				...
				type: "name",
				title: "Activer L2TP Passthrough",
				...
				type: "name",
				title: "Activer IPSec Passthrough",
		...
		PORT_TRIGGERING: {
			...
			CONTENT: [{
				...
				content: [{
					type: "note",
					title: "Remarque",
					content: "Chaque règle ne peut concerner qu'un hôte unique."
				},
					"1. Cliquer sur Ajouter.",
		...
		FOLDER_SHARE_ACCOUNT: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Nom d'utilisateur/Mot de passe",
				content: "Définir des identifiants composés de 15 caractères alphanumériques. Le nom d'utilisateur doit impérativement commencer par une lettre."
			},{
				type: "name",
		...
		FOLDER_SHARE_SETTINGS: {
			...
			CONTENT: [{
				type: "name",
				title: "Nom duserveur : de médias/réseau",
		...
		FOLDER_SHARE_FOLDERS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Autoriser l'accès aux invités",
		...
		PARENTAL_CONTROL: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Contrôle parental",
				content: "Basculer sur On pour activer le contrôle parental."
			}]
		},
		...
		PARENTAL_CONTROL_RESTRICTION: {
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Les mots peuvent être des nom de domaine : www.gmail.com ou www.facebook.com par exemple."
			}]
		},
		...
		SECURITY_DOS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Interdire les paquets PING issus du port LAN",
		...
		ACCESS_DEVICE: {
			...
			CONTENT: [{
				...
				content: "Dans la table des appareils connectés, sélectionner tous les appareils que vous souhaitez bloquer, cliquer sur l'icône Bloquer au dessus de la table. Les appareils seront automatiquement ajoutés à la liste noire."
			}],
		},
		...
		IPMAC_BIND_ARP: {
			...
			CONTENT: [{
				...
				type: "note",
				title: "Remarque",
				content: "Vous ne pouvez pas associer la même adresse IP à plusieurs adresses MAC."
			}]
		},
		...
		IPV6: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Utiliser les serveurs DNS suivant",
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "Avant de mette à jour le logiciel (firmware) du routeur, vous devez télécharger sur votre ordinateur la dernière version disponible depuis le site <a class=\"link\" target=\"_blank\" href=\"http://www.tp-link.fr/Support/\">TP-Link Support.</a>"
			},{
				type: "step",
		...
		ADMIN_ACCOUNT: {	
			...
			CONTENT: [{
				...
				type: "note",
				title: "Remarque",
				content: "Si vous décidez de modifier les valeurs par défaut assurez vous de les noter et de les mettre en lieu sûr."
			},{
				type: "paragraph",
				content: "Cliquer sur Sauvegarder pour enregistrer tous vos paramètres."
			}]
		...
		ADMIN_RECOVERY: {
			...
			CONTENT: [{
				type: "name",
				title: "Activer récupération du Mot de passe",
		...
		ADMIN_LOCAL: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Accès autorisé à tous les appareils connectés au LAN",
		...
		ADMIN_REMOTE: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Activer l'administration distante pour les appareils spécifiés",
				...
				content: "Saisir une adresse IP valide ou une plage d'adresses IP autorisées à accéder au routeur. La valeur 255.255.255.255 autorise n'importe quelle IP à accéder au routeur."
			},{
				type: "paragraph",
				content: "Cliquer sur Sauvegarder pour enregistrer tous vos paramètres."
			}]
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX Beamforming est une technique de traitement du signal utilisée dans les groupes de capteurs pour des transmissions de signaux directionnelles. Une fois activé, le signal Wi-Fi émis est renforcé et sa portée étendue."
			},{
				type: "name",
				...
				children: [{
					...
					content: "Saisir l'adresse MAC (BSSID) du point d'accès auquel le routeur va se connecter pour réaliser un pont en respectant le format suivant : 12 caractères hexadécimaux (0 à9; a à f ou A à F) séparés deux à deux par des tirets. L'adresse MAC est automatiquement renseignée lors de l'utilisation de la fonction Recherche."
				},{
					type: "name",
					title: "Sécurité",
		...
		SYSTEM_PARA_DOS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Niveau de paquets ICMP-FLOOD",
		...
		OPEN_VPN:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Avec OpenVPN, vous pouvez utiliser internet pour accéder de façon sécurisée à votre réseau domestique quand vous n'êtes pas à la maison. Pour utiliser le service VPN, vous devez configurer le service de DNS Dynamique (Recommandé) ou assigner une adresse IP statique au port WAN de votre routeur. Votre heure système doit être synchronisée avec internet."
			},{
				type: "name",
				title: "Activer le serveur VPN",
				content: "Sélectionnez cette case pour activer le serveur OpenVPN."
			},{
				type: "name",
				title: "Type de Service",
				...
				type: "name",
				title: "Accès clients",
				content: "Sélectionnez le type d'accès pour votre client OPenVPN.",
				children: [{
					type: "name",
					title: "Réseau domestique exclusivement",
					content: "Les clients peuvent uniquement accéder au routeur et au LAN. Le routeur par défaut du client ne sera pas modifié."
				},{
					type: "name",
					title: "Réseau Internet et domestique",
					content: "Les clients peuvent accéder au réseau domestique, au sites internet ou aux services soumis à des limitations géographiques quand vous êtes hors de votre pays. La route par défaut du client sera altérée."
				}]
			}]
		},
		OPEN_VPN_CERTIFICATE:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Utilise ce certificat pour obtenir des informations et l'identité de la connexion VPN pour l'ordinateur distant."
			},{
				type: "name",
				title: "Générer",
				content: "Cliquez pour générer un nouveau certificat."
			}]
		},
		OPEN_VPN_CONF:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Les clients distants devront utiliser le fichier de configuration pour accéder à votre routeur."
			},{
				type: "name",
				title: "Exporter",
				content: "Cliquez sur ce bouton pour enregistrer le fichier de configuration OpenVPN qui peut être réutilisé pour ajouter des nouvelles  connexions VPN."
			}]
		},
		OPEN_VPN_GUIDE:{
			...
			CONTENT: [{
				type: "step",
				title: "Pour activer et connecter vos dispositifs clients au serveur OPenVPN :",
				content:[{
					type: "paragraph",
					content: "Avant de configurer le serveur OpenVPN, merci de configurer le service de DNS Dynamique ou assigner une adresse IP statique au port WAN. Assurez vous que le port Externe des paramètres NAT n'est pas le port de service et que les paramètres horaires sont synchronisés via internet."
				},
					...
					"4. Sur vos clients télécharger et installer le client OpenVPN depuis <a class=\"link\" href=\"http://openvpn.net/index.php/download/community-downloads.html\">http://openvpn.net/index.php/download/community-downloads.html</a><br>  Les plateformes officiellement supportées sont : Windows, OS X, Linux.",
					"5. Lancer l'utilitaire client OpenVPN et ajouter une nouvelle connexion VPN en utilisant le fichier de configuration sauvegardé pour connecter le client au serveur VPN."
				]},{
					type: "note",
					title: "Remarque",
		...
		PPTP_VPN:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Avec un VPN PPTP, vous pouvez utiliser internet pour accéder rapidement et aisément à votre réseau quand vous n'êtes pas à la maison. Cela peut-être empêché par certains FAI.  Pour utiliser le service VPN, vous devez configurer le service de DNS Dynamique (Recommandé) ou assigner une adresse IP statique au port WAN de votre routeur. Votre heure système doit être synchronisée avec internet."
			},{
				type: "name",
				title: "Activer le serveur VPN",
				content: "Sélectionnez cette case pour activer le serveur PPTP VPN."
			},{
				type: "name",
		...
		PPTP_ACCOUNT_LIST:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Ce tableau affiche les comptes pouvant être utilisés pour vous connecter au serveur VPN PPTP depuis des clients distants. "
			},{
				type: "step",
				title: "Pour ajouter un compte VPN PPTP",
				content: [
					"1. Cliquer sur Ajouter.",
					"2. Saisissez le nom d'utilisateur et le mot de passe pour authentifier les clients du serveur PPTP VPN.",
					"3. Cliquer sur OK."
				]
			},{
				type: "step",
				title: "Pour modifier ou supprimer un compte",
				content: "Dans le tableau, cliquez sur l'icône Modifier ou Poubelle du compte que vous souhaitez modifier ou supprimer."
			}]
		},
		PPTP_VPN_GUIDE:{
			TITLE: "Guide d'installation de client VPN",
			CONTENT: [{
				type: "step",
				title: "Pour activer et connecter vos dispositifs clients au serveur PPTP VPN :",
				content:[{
					type: "paragraph",
					content: "Avant de configurer le serveur VPN PPTP, merci de configurer le service de DNS Dynamique ou assigner une adresse IP statique au port WAN. Assurez vous que le port Externe des paramètres NAT n'est pas 1723 et que les paramètres horaires sont synchronisés via internet."
				},
					"1) Cocher activer le serveur VPN",
					"2. Configurer les paramètres du serveur VPN PPTP et cliquer sur Sauvegarder.",
					"3. Sur vos clients, créer une connexion VPN PPTP. Les plateformes officiellement supportées incluent : Windows, OS X, Linux, iOS et Android.",
					"4. Lancer le programme de VPN PPTP, ajouter une nouvelle connexion et saisir le nom de domaine ou le service de DNS dynamique ou l'adresse IP statique assignée au port WAN, pour connecter votre client au serveur VPN PPTP."
				]}
			]
		},
		VPN_CONNNECTION:{
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Cliquez sur l'icône Moins pour déconnecter le client correspondant."
			}]
		},
		...
		BASIC_NETWORK_ROUTER: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Canal",
				content: "Affiche le canal depuis lequel les signaux 2.4GHz/5GHZ sont diffusés."
			},{
				type: "name",
				title: "Adresse MAC",
				content: "Affiche l'adresse MAC de l'émetteur Wi-Fi 2.4GHz/5GHz."
			},{
				type: "title",
				title: "Réseau client 2,4GHz/5GHz "
			},{
				type: "name",
				title: "Etat",
		...
		BASIC_NETWORK_USB: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Capacité",
				content: "Affiche la capacité totale du disque USB."
			},{
				type: "name",
				title: "Disponible",
				content: "Affiche la capacité disponible du disque USB."
			}]
		},
		BASIC_INTERNET: {
			TITLE: "Internet",
			CONTENT: [{
				...
				type: "note",
				title: "Remarque",
				content: "Si vous n'êtes pas sûr du type de votre connexion internet, utilisez la détection automatique ou contactez votre FAI pour solliciter son assistance."
			},{
				type: "title",
				title: "Type de Connexion internet : IP Statique",
			},{
		...
		BASIC_WIRELESS: {
			...
			CONTENT: [{
				type: "name",
				title: "Activer l'émetteur Wi-Fi",
				content: "Cocher la case \"Activer l’émetteur Wi-Fi\" pour activer le réseau Wi-Fi 2.4GHz/5GHz."
			},{
				type: "name",
				title: "Nom de réseau (SSID)",
				...
				type: "name",
				title: "Masquer le SSID",
				content: "Cocher cette case si vous décidez que le nom du réseau Wi-Fi 2.4GHz/5GHz ne doit pas apparaitre dans la liste des réseaux disponibles."
			},{
				type: "name",
				title: "Mot de passe",
		...
		BOUND_ACCOUNT:{
			...
			CONTENT:[{
				...
				content:["1. Cliquer sur Associer.",
