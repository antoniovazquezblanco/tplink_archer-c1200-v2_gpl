	...
	$.su.CHAR.HELP = {
				...
				},
				{
					...
					children: [
						...
						},
						{
							type: "name",
							title: "葡萄牙-MEO",
							content: "如果您的ISP是葡萄牙-MEO並且必要的參數已經預先決定，包括網際網路VLAN ID、優先級以及LAN（1/2/3/4）連接埠功能，請選擇此項目。"
						},
						{
							type: "name",
							title: "葡萄牙-Vodafone",
							content: "如果您的ISP是葡萄牙-Vodafone並且必要的參數已經預先決定，包括網際網路/IP電話/IPTV以及VLAN ID和優先級，請選擇此項目。您可以根據需要（網際網路供應商/IPTV供應商/IP電話供應商/網際網路-IPTV供應商）分別為LAN連接埠分配各自的功能。"
						},
						{
							type: "name",
							title: "自訂",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "位址租用時間",
				content: "請輸入IP租用時間，範圍介於1-2880分鐘之間。預設值為120分鐘。"
			},{
				type: "name",
				title: "預設閘道",
		...
		DDNS: {
			...
			CONTENT: [{
				...
				content: [
					...
					"5. 如果您的服務供應商是NO-IP，請選擇WAN IP綁定以確保該網域名稱已經綁定到此路由器的WAN IP。",
					"6. 點選登入並儲存。"
				]
			},{
				type: "note",
		...
		SECURITY_DOS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "忽視來自於 WAN 連接埠的PING封包",
				content: "啟用以忽視來自WAN埠的ping封包。"
			},{
				type: "name",
				title: "禁止來自於 LAN 連接埠的PING封包",
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX束波成形是一種訊號處理技術，它被用於感應器陣列中的指向訊號傳輸。 如果啟用此能，它將會被使用在發射端，以加強Wi-Fi訊號和擴展Wi-Fi覆蓋範圍。"
			},{
				type: "name",
		...
		OPEN_VPN:{
			...
			CONTENT: [{
				...
				children: [{
					type: "name",
					title: "僅限家庭網路",
					content: "用戶端只能存取路由器和 LAN。用戶端的預設路由將不改變。"
				},{
					type: "name",
					title: "網際網路和家庭網路",
		...
		OPEN_VPN_CERTIFICATE:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "將憑證用於資訊，並將 VPN 連線的身分識別用於遠端電腦。"
			},{
				type: "name",
				title: "生成",
				content: "按一下來產生新憑證。"
		...
		OPEN_VPN_CONF:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "遠端用戶端將會使用該設定檔以存取您的路由器。"
			},{
				type: "name",
				title: "匯出",
				content: "按一下這個按鈕來儲存可用於新增 VPN 連線的 OpenVPN 組態檔。"
			}]
		},
		OPEN_VPN_GUIDE:{
			TITLE: "VPN 用戶端安裝指南",
			CONTENT: [{
				type: "step",
				title: "若要啟用 OpenVPN 伺服器，請將您的用戶端裝置連線至此伺服器：",
				content:[{
					type: "paragraph",
		...
		PPTP_VPN_GUIDE:{
			...
			CONTENT: [{
				type: "step",
				title: "若要啟用 PPTP VPN 伺服器，請將您的用戶端裝置連線至此伺服器：",
				content:[{
					type: "paragraph",
					content: "在您繼續設定PPTP VPN伺服器前，請設定動態DNS服務（推薦）或指派給WAN埠一個固定IP位址。並確定您的NAT設定的外部通訊埠不是1723，並且您的系統時間與網際網路同步。"
				},
					"1. 選擇啟用VPN伺服器。",
