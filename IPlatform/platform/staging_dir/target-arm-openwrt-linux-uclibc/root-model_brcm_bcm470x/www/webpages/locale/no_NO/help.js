	...
	$.su.CHAR.HELP = {
		...
		STATUS_WIRELESS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Kanal",
				content: "Den nåværende trådløse kanalen og den tilsvarende frekvensen (i GHz)."
			},{
				type: "name",
				title: "MAC-adresse",
		...
		INTERNET_INTERNET: {
			...
			CONTENT: [{
				...
				content: "Hvis din Internett-leverandøren gir spesifikke (faste) DNS-IP-adresser, velger du Bruk følgende DNS-adresse og skriver inn adressen(e) i feltene for primær og sekundær DNS. Ellers velger du Hent dynamisk fra Internett-leverandøren for å få en DNS-IP-adresse tildelt automatisk fra serveren."
			},{
				type: "name",
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Modus",
					content: "Velg ønsket modus i henhold til din Internett-leverandør.",
					children: [
						{
							type: "name",
							title: "Bro",
						...
						},
						{
							type: "name",
							title: "Russland",
							content: "Velg hvis din Internett-leverandør er fra Russland og de nødvendige parameterne er forhåndsbestemt, inkludert Internett/IP-telefon/IPTV VLAN-IDer og Prioritet, samt LAN (1/2/3/4) portfunksjoner.",
							children: [{
								type: "name",
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "– Velg dersom ISP-en din er Portugal-MEO og de nødvendige parameterne er forhåndsbestemte,inkludert Internett VLAN ID og prioritet, og LAN (1/2/3/4) portfunksjoner."
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "– Velg dersom ISP-en din er Portugal-Vodafone og de nødvendige parameterne er forhåndsbestemte, inkludert Internett/IP-Telefon/IPTV VLAN ID-er og prioritet. Du kan tilordne funksjoner til LAN-portene dine henholdsvis etter behov (Internettleverandør/IPTV-leverandør/IP-telefonleverandør/Internett-IPTV-leverandør)."
						},
						{
							type: "name",
							title: "Tilpasset",
		...
		DHCP_SERVER_SETTINGS: {
			...
			CONTENT: [{
				...
				content: "Angi varighet for IP-adressens utleieperiode til klienten, mellom 1 og 2880 minutter. Standardverdi er 120 minutter."
			},{
				type: "name",
				title: "Standard gateway",
		...
		DDNS: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Dynamisk DNS (domenenavnsystem) lar deg tilordne en fast vert og domenenavn til en dynamisk IP-adresse på Internett. Det er nyttig når du drifter ditt eget nettsted, FTP-server eller en annen server bak ruteren. Først må du registrere deg hos en dynamisk DNS-tjenesteleverandør, slik som www.dyndns.com. Så skriver du inn registreringsinformasjonen."
			},{
				type: "step",
				...
				content: [
					...
					"3. Angi domenenavnet du registrerte med dynamisk DNS-tjenesteleverandør.",
					"4. Velg tidsintervallet der oppdateringsforespørselen for dynamisk blir sendt.",
					"5. Hvis tjenesteleverandøren er NO-IP, må du velge binding av WAN IP for å sikre at domenenavnet blir bundet til ruterens WAN IP.",
					"6. Klikk Logg inn og Lagre."
				]
			},{
				type: "note",
				title:"Merk",
				content: "Hvis du vil bruke en ny DDNS-konto, må du først logge deg ut og så logge deg på med den nye kontoen."
			}]
		},
                DYNAMIC_DNS: {
			TITLE: "Dynamisk DNS",
		...
		DOMAIN_NAME_LIST: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Denne tabellen viser Dynamic DNS-domenenavn som er registrerte med TP-Link ID."
			},{
				type:"step",
				title: "For å registrere et nytt domenenavn",
				content: [
					"1. Klikk Registrer.",
					"2. Skriv inn enhetsnavnet.",
					"3. Klikk Lagre."
					]
			}]
		},
		...
		WIRELESS_24G: {	
			...
			CONTENT: [{
				...
				content: "Velg dette alternativet for å aktivere den trådløse 2,4 GHz radiofrekvensen."
			},{
				type: "name",
				title: "Navn på trådløst nettverk (SSID)",
				...
				type: "name",
				title: "Skjul SSID",
				content: "Velg denne avmerkingsboksen hvis du ønsker å skjule navnet på 2,4 GHz-nettverket (SSID) fra Wi-Fi-nettverkslisten."
			},{
				type: "name",
				title: "Sikkerhet",
				...
				children: [{
					...
					type: "name",
					title: "WEP",
					content: "Velg dette alternativet for å aktivere enkel godkjenningsmetode hvis noen av dine klientenheter bare har tilgang til trådløst nettverk ved hjelp av WEP (Wired Equivalent Privacy).",
					children: [{
						type: "name",
						title: "Type",
		...
		WIRELESS_5G: {	
			...
			CONTENT: [{
				type: "name",
				title: "Aktiver trådløs radio",
				content: "Velg dette alternativet for å aktivere den trådløse 5GHz radiofrekvensen."
			},{
				type: "name",
				title: "Navn på trådløst nettverk (SSID)",
				content: "Du kan la standard nettverksnavn (SSID) stå som det er, eller angi et nytt navn (på opptil 32 tegn). Dette feltet skiller mellom store og små bokstaver."
				...
				type: "name",
				title: "Skjul SSID",
				content: "Velg denne avmerkingsboksen hvis du ønsker å skjule navnet på 5GHz-nettverket (SSID) fra Wi-Fi-nettverkslisten."
			},{
				type: "name",
				title: "Sikkerhet",
				content: "Velg en av de følgende sikkerhetsinnstillingene:",
		...
		FOLDER_SHARE_ACCOUNT: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Brukernavn/passord",
				content: "Skriv inn et alfanumerisk eller under line string på inntil 15 tegn. Brukernavnet må starte med et alfabetisk tegn. Disse feltene skiller mellom store og små bokstaver."
			},{
				type: "name",
		...
		PARENTAL_CONTROL: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Sperrefunksjon",
				content: "Skru På for å aktivere Sperrefunksjoner."
			}]
		},
		...
		PARENTAL_CONTROL_DEVICES: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Beskrivelse",
				content: "Viser en kort beskrivelse for den tilkoblede enheten."
			},{
				type: "name",
				title: "Status",
		...
		PARENTAL_CONTROL_RESTRICTION: {
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Nøkkelord kan også være et domenenavn, for eksempel www.mail.google.com eller www.facebook.com."
			}]
		},
		...
		SECURITY_DOS: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "ICMP-FLOOD Attack-filtrering",
		...
		ACCESS_DEVICE: {
			...
			CONTENT: [{
				...
				content: "Velg alle reglene som du ønsker å blokkere i tabellen for Tilkoblede enheter, og klikk så på Slett over tabellen. Enheten vil automatisk bli lagt til enhetene i svartelisten eller hvitelisten."
			}],
		},
		...
		FIRMWARE: {	
			...
			CONTENT: [{
				type: "paragraph",
				content: "Før du oppgraderer ruterens fastvare må du laste ned den nyeste fastvareoppdateringen fra <a class=\"link\" target=\"blank\" href=\"http://www.tp-link.com/no/Support/\">TP-Link Support</a>-nettsiden til din datamaskin."
			},{
				type: "step",
		...
		FACTORY: {
			TITLE: "Tilbakestille enheten til fabrikkstandard",
			CONTENT: [{
				type: "paragraph",
		...
		ADMIN_REMOTE: {	
			...
			CONTENT: [{
				...
				content: "Angi en gyldig IP-adresse eller IP-område for å få tilgang til ruteren."
			},{
				type: "paragraph",
				content: "Klikk på Lagre for å lagre alle innstillingene."
			}]
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX Beamforming er en teknikk til signalprosessering som brukes for retningsbestemte signaloverføringer i sensorrekker. Hvis aktivert, brukes det på sendersiden for å forsterke Wi-Fi-signalet og utvide Wi-Fi-rekkevidden."
			},{
				type: "name",
				...
				children: [{
					...
					content: "Angi MAC-adressen (BSSID) med 12 heksadesimale tegn (0–9, a–f, A–F), atskilt med bindestrek, for det trådløse tilgangspunktet som ruteren skal kobles til som klient. Hvis du velger ønsket AP gjennom Oversikt-funksjonen, vil MAC-adressefeltet fylles inn automatisk."
				},{
					type: "name",
					title: "Sikkerhet",
		...
		OPEN_VPN:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Med åpen VPN kan du bruke Internett for sikker tilgang til ditt nettverk når du ikke er hjemme. For å bruke VPN-tjenesten, må du konfigurere Dynamisk DNS-service (anbefalt) eller gi en statisk IP-adresse for ruterens WAN-portal. Og systemtiden din skal synkroniseres med Internett."
			},{
				type: "name",
				title: "Aktiver VPN-serveren",
				content: "Velg dette alternativet for å aktivere OpenVPN-server."
			},{
				type: "name",
				title: "Tjenestetype",
				...
				children: [{
					...
					content: "Klienter kan bare få tilgang til ruteren og LAN. Kundens standardrute vil ikke endres."
				},{
					type: "name",
					title: "Internett og hjemmenettverk",
					content: "Kunder kan få tilgang til hjemmenettverket og nettsteder eller tjenester med en geografisk begrensning når du er utenlands. Kundens standardrute vil endres."
				}]
			}]
		},
		OPEN_VPN_CERTIFICATE:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Bruk sertifikatet for å innhente informasjon om, og identiteten til, VPN-tilkoblingen for den eksterne datamaskinen."
			},{
				type: "name",
				title: "Generer",
		...
		OPEN_VPN_CONF:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Fjernkunder vil bruke konfigurasjonsfilen for å få tilgang til din ruter."
			},{
				type: "name",
				title: "Eksporter",
				content: "Klikk på denne knappen for å lagre OpenVPN-konfigurasjonsfilen som skal brukes til å legge til en ny VPN-tilkobling."
			}]
		},
		OPEN_VPN_GUIDE:{
			...
			CONTENT: [{
				type: "step",
				title: "For å aktivere og tilkoble dine klientenheter til OpenVPN-serveren:",
				content:[{
					type: "paragraph",
					content: "Før du konfigurerer den åpne VPN-serveren, må du konfigurere Dynamisk DNS-service (anbefalt) eller gi en statisk IP-adresse for WAN-portalen. Og sørg for at din eksterne portal av NAT-innstillinger ikke er serviceportalen og din Systemtid er synkronisert med Internett."
				},
					...
					"4. Last ned og installer kundeverktøyet for åpen VPN på dine kundeenheter, fra <a class=\"link\" href=\"http://openvpn.net/index.php/download/community-downloads.html\">http://openvpn.net/index.php/download/community-downloads.html</a><br> De offisielt støttede plattformene inkluderer Windows, Mac OSX, Linux.",
					"5. Start OpenVPN-klientverktøyet og legg til en ny VPN-tilkobling ved hjelp av den lagrede konfigurasjonsfilen for å koble klientenheten til VPN-serveren."
				]},{
					type: "note",
					title: "Merk",
		...
		PPTP_VPN:{
			...
			CONTENT: [{
				type: "paragraph",
				content: "Med PPTP VPN kan du bruke Internett for enkel og rask tilgang til ditt nettverk når du ikke er hjemme. Noen Internettleverandører kan forhindre dette. For å bruke VPN-tjenesten, må du konfigurere Dynamisk DNS-service (anbefalt) eller gi en statisk IP-adresse for ruterens WAN-portal. Og systemtiden din skal synkroniseres med Internett."
			},{
				type: "name",
				title: "Aktiver VPN-serveren",
				content: "Velg dette alternativet for å aktivere PPTP VPN-server."
			},{
				type: "name",
				...
				type: "name",
				title: "Tillat Samba (nettverkssted)-tilgang",
				content: "Velg for å tillate VPN-kunden din å få tilgang til din lokale Samba-server."
			},{
				type: "name",
				title: "Tillat NetBIOS direkte kommunikasjon",
				content: "Velg for å tillate VPN-kunden din å få tilgang til din lokale Samba-server ved å bruke NetBIOS-navn."
			},{
				type: "name",
				title: "Tillatt ukrypterte tilkoblinger",
				content: "Velg for å tillate ukrypterte tilkoblinger til VPN-serveren din."
			}]
		},
		PPTP_ACCOUNT_LIST:{
			TITLE: "Kontoliste",
			CONTENT: [{
				type: "paragraph",
				content: "Dette skjemaet viser kontoene som kan brukes til å koble til PPTP VPN-serveren av de eksterne kundene."
			},{
				type: "step",
				title: "For å legge til en PPTP VPN-konto",
				content: [
					"1. Klikk Legg til.",
					"2. Skriv inn brukernavn og passord for å godkjenne klienter for tilgang til PPTP VPN-serveren.",
					"3. Klikk på OK."
				]
			},{
				type: "step",
				title: "For å endre eller slette en eksisterende konto",
				content: "Klikk på Endre-ikonet i tabellen, eller Papirkurv-ikonet som samsvarer med den kontoen du ønsker å endre eller slette."
			}]
		},
		PPTP_VPN_GUIDE:{
			TITLE: "Installasjonsveiledning for VPN-klient",
			CONTENT: [{
				type: "step",
				title: "For å aktivere og tilkoble dine klientenheter til PPTP VPN-serveren:",
				content:[{
					type: "paragraph",
					...
					"3. Opprette en PPTP VPN-tilkobling på kundeenhetene dine. De offisielt støttede plattformene inkluderer Windows, Mac OSX, Linux, iOS, og Android.",
					"4. Start PPTP VPN-programmet, legg til en ny tilkobling og skriv domenenavnet på den registrerte DDNS-tjenesten eller den statiske IP-adressen som er tilordnet WAN-porten, for å koble klientenheten til PPTP VPN-serveren."
				]}
			]
		},
		VPN_CONNNECTION:{
			...
			CONTENT: [{
				...
				type: "paragraph",
				content: "Klikk på Minus-ikonet for å koble fra tilsvarende klient."
			}]
		},
		...
		BASIC_NETWORK_ROUTER: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "Kanal",
				content: "Viser kanalen som sender de trådløse 2,4/5 GHz nettverksendingene."
			},{
				type: "name",
				title: "MAC",
				content: "Viser den gjeldende MAC-adressen til det trådløse 2,4/5 GHz-nettverket."
			},{
				type: "title",
				title: "2,4GHz/5GHz gjestenettverk"
			},{
				type: "name",
				title: "Status",
		...
		BASIC_NETWORK_USB: {
			...
			CONTENT: [{
				type: "name",
				title: "USB-enhet",
				content: "Vis navn på USB-enheten som er koblet til ruteren."
			},{
				type: "name",
				title: "Totalt",
				content: "Vis total lagringskapasitet på den tilkoblede USB-lagringsenheten."
			},{
				type: "name",
				title: "Tilgjengelig",
				content: "Vis tilgjengelig lagringskapasitet på den tilkoblede USB-lagringsenheten."
			}]
		},
		BASIC_INTERNET: {
			TITLE: "Internett",
		...
		BASIC_WIRELESS: {
			...
			CONTENT: [{
				type: "name",
				title: "Aktiver trådløs radio",
				content: "Velg dette alternativet for å aktivere den trådløse 2,4/5 GHz radiofrekvensen."
			},{
				type: "name",
				title: "Navn på trådløst nettverk (SSID)",
				content: "Du kan la standard nettverksnavn (SSID) stå som det er, eller angi et nytt navn (på opptil 32 tegn). Dette feltet skiller mellom store og små bokstaver."
				...
				type: "name",
				title: "Skjul SSID",
				content: "Velg denne avmerkingsboksen hvis du ønsker å skjule navnet på 2,4/5 GHz-nettverket (SSID) fra Wi-Fi-nettverkslisten."
			},{
				type: "name",
				title: "Passord",
