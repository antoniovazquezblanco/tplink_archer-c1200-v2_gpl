	...
	$.su.CHAR.HELP = {
		...
		IPTV:{
			...
			CONTENT: [{
				...
				},
				{
					type: "name",
					title: "Mode",
					content: "Select the appropriate mode according to your ISP.",
					children: [
						{
							type: "name",
							title: "Bridge",
						...
						},
						{
							type: "name",
							title: "Portugal-MEO",
							content: "Select if your ISP is Portugal-MEO and the necessary parameters are predetermined, including Internet VLAN ID and Priority,  and LAN (1/2/3/4) port features."
						},
						{
							type: "name",
							title: "Portugal-Vodafone",
							content: "Select if your ISP is Portugal-Vodafone and the necessary parameters are predetermined, including Internet/IP-Phone/IPTV VLAN IDs and Priority. You can reassign your LAN ports to their functions respectively as needed (Internet supplier/IPTV supplier/IP-Phone supplier/Internet-IPTV supplier)."
						},
						{
							type: "name",
							title: "Custom",
		...
		WIRELESS_STATISTICS: {	
			...
			CONTENT: [{
				...
				type: "name",
				title: "Connection Type",
				content: "Displays the wireless frequency band (2.4GHz/5GHz) of the associated wireless client."
			},{
				type: "name",
				title: "Security",
		...
		SYSTEM_PARA_WIRELESS: {
			...
			CONTENT: [{
				...
				content: "TX Beamforming is a signal processing technique used in sensor arrays for directional signal transmission. If enabled, it will be used at the transmitting end in order to reinforce the Wi-Fi signal and extend the Wi-Fi coverage."
			},{
				type: "name",
