...
#if CONFIG_GPIO_ENABLE_BLUE_LAN
    {
		.name       = "blue:lan",
		.gpio       = CONFIG_GPIO_BLUE_LAN,  /* 1 */
		.active_low = CONFIG_GPIO_BLUE_LAN_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_LAN1
    {
		.name       = "blue:lan1",
		.gpio       = CONFIG_GPIO_BLUE_LAN1,  /* 15 */
		.active_low = CONFIG_GPIO_BLUE_LAN1_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_LAN2
    {
		.name       = "blue:lan2",
		.gpio       = CONFIG_GPIO_BLUE_LAN2,  /* 13 */
		.active_low = CONFIG_GPIO_BLUE_LAN2_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_LAN3
    {
		.name       = "blue:lan3",
		.gpio       = CONFIG_GPIO_BLUE_LAN3,  /* 6 */
		.active_low = CONFIG_GPIO_BLUE_LAN3_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_LAN4
    {
		.name       = "blue:lan4",
		.gpio       = CONFIG_GPIO_BLUE_LAN4,  /* 8 */
		.active_low = CONFIG_GPIO_BLUE_LAN4_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_USB_1
	{
		.name       = "blue:usb_1",
		.gpio       = CONFIG_GPIO_BLUE_USB_1,  /* 7 */
		.active_low = CONFIG_GPIO_BLUE_USB_1_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_USB_3
	{
		.name       = "blue:usb_3",
		.gpio       = CONFIG_GPIO_BLUE_USB_3,  /* 6 */
		.active_low = CONFIG_GPIO_BLUE_USB_3_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_WPS
	{
		.name       = "blue:wps",
		.gpio       = CONFIG_GPIO_BLUE_WPS,  /* 2 */
		.active_low = CONFIG_GPIO_BLUE_WPS_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_WAN
	{
		.name       = "blue:wan",
		.gpio       = CONFIG_GPIO_BLUE_WAN,  /* 14 */
		.active_low = CONFIG_GPIO_BLUE_WAN_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_ORANGE_WAN
	{
		.name       = "orange:wan",
		.gpio       = CONFIG_GPIO_ORANGE_WAN,  /* 15 */
		.active_low = CONFIG_GPIO_ORANGE_WAN_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_STATUS
	{
		.name       = "blue:status",
		.gpio       = CONFIG_GPIO_BLUE_STATUS,  /* 18 */
		.active_low = CONFIG_GPIO_BLUE_STATUS_ACTIVE_LOW,  /* 1 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_WLAN_2G
	{
		.name       = "blue:wlan_2g",
		.gpio       = CONFIG_GPIO_BLUE_WLAN_2G,  /* 4 */
		.active_low = CONFIG_GPIO_BLUE_WLAN_2G_ACTIVE_LOW,  /* 0 */
	},
#endif
#if CONFIG_GPIO_ENABLE_BLUE_WLAN_5G
	{
		.name       = "blue:wlan_5g",
		.gpio       = CONFIG_GPIO_BLUE_WLAN_5G,  /* 5 */
		.active_low = CONFIG_GPIO_BLUE_WLAN_5G_ACTIVE_LOW,  /* 0 */
	},
#endif
/*	{
...
struct gpio_keys_button bcm_gpio_keys[]=
{
#if CONFIG_GPIO_ENABLE_WIFI_BUTTON
	{
		.desc = "wifi",
		.gpio = CONFIG_GPIO_WIFI_BUTTON,
	},
#endif
#if CONFIG_GPIO_ENABLE_RESET_BUTTON
	{
		.desc = "reset",
		.gpio = CONFIG_GPIO_RESET_BUTTON,
	},
#endif
    {
		.desc = 0
...
#if CONFIG_SPI_BCM47XX

static struct platform_device bcm_spi_device = {
	.name = "bcm5301x-spi-master",
	.id   = 1,
};
...
void __init soc_add_devices(void)
{
	...
	#if CONFIG_SPI_BCM47XX
	platform_device_register(&bcm_spi_device);
