...
#define TP_BUTTON_DEFAULT_PBKBITMAP     {NULL, NULL, NULL}
/// TP_Button默认背景颜色：绿，红，白
#define TP_BUTTON_DEFAULT_ABKCOLOR      {0x97cc58, GUI_RED, GUI_WHITE}
/// TP_Button默认背景颜色透明度：完全不透明
#define TP_BUTTON_DEFAULT_BKCOLORALPHA  0
/// TP_Button默认文本内容：无文本
#define TP_BUTTON_DEFAULT_PTEXT         NULL
/// TP_Button默认文本颜色：白，蓝，黑
#define TP_BUTTON_DEFAULT_ATEXTCOLOR    {0xf8ffe4, GUI_BLUE, GUI_BLACK}
/// TP_Button默认文本字体：冬青黑
...
#define TP_BUTTON_DEFAULT_RADIUS        1
...
typedef struct
{
    ...
    /// 背景图片
	const GUI_BITMAP *  pBkBitmap[TP_BUTTON_STATE_COUNT];
    /// 背景颜色
 ...
 * \brief        控件的回调函数。
 *
 * 允许用户自定义回调函数。控件中处理了WM_PAINT，WM_PID_STATE_CHANGED，WM_TOUCH，WM_SET_FOCUS，WM_DELETE，WM_GET_ID，WM_SET_ID等消息。
 * \param        pMsg    窗口消息。
 */
