...
#if (GUI_NUM_LAYERS > 1)
  #define COLOR_CONVERSION_1 GUICC_M565//GUICC_M8888I
...
#define LCD_LAYER1_FRAME_BUFFER  ((uint32_t)0xD0200000)
...
static void LCD_LL_Init(void)
{
  static RCC_PeriphCLKInitTypeDef  PeriphClkInitStruct;
      ...
      hltdc.Init.AccumulatedActiveH = 333;
      hltdc.Init.AccumulatedActiveW = 603;
      hltdc.Init.TotalHeigh = 335;
      hltdc.Init.TotalWidth = 605;
