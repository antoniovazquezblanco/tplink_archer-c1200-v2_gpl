...
GUI_COLOR TP_Menu_GetBkColor (TP_MENU_Handle hObj, I32 colorIdx)
{
	TP_MENU_OBJ obj;
...
void TP_Menu_SetBkColor   (TP_MENU_Handle hObj, I32 colorIdx, GUI_COLOR color)
{
	TP_MENU_OBJ obj;
...
U8 TP_Menu_GetBorderSize(TP_MENU_Handle hObj, I32 idx)
{
	TP_MENU_OBJ obj;
...
void TP_Menu_SetBorderSize(TP_MENU_Handle hObj, I32 idx, U8 BorderSize)
{
	TP_MENU_OBJ obj;
...
GUI_COLOR TP_Menu_GetTextColor (TP_MENU_Handle hObj, I32 idx)
{
	TP_MENU_OBJ obj;
...
void TP_Menu_SetTextColor (TP_MENU_Handle hObj, I32 idx, GUI_COLOR color)
{
	TP_MENU_OBJ obj;
...
GUI_COLOR TP_Menu_GetDefaultTextColor (I32 idx)
{
	if (idx < TP_MENU_ITEM_TEXT_CI_MIN || idx >= TP_MENU_ITEM_TEXT_CI_MAX)
	{
		return GUI_INVALID_COLOR;
...
void TP_Menu_SetDefaultTextColor  (I32 idx, GUI_COLOR color)
{
	if (idx < TP_MENU_ITEM_TEXT_CI_MIN || idx >= TP_MENU_ITEM_TEXT_CI_MAX)
	{
		return;
...
GUI_COLOR TP_Menu_GetDefaultBkColor (I32 idx)
{
...
void TP_Menu_SetDefaultBkColor(I32 idx, GUI_COLOR color)
{
	if (idx < TP_MENU_ITEM_BK_CI_MIN || idx >= TP_MENU_ITEM_BK_CI_MAX)
	{
		return;
...
U8 TP_Menu_GetDefaultBorderSize (I32 idx)
{
	if ((idx >= TP_MENU_BORDER_INDEX_MIN) && (idx < TP_MENU_BORDER_INDEX_MAX))
	{
...
void TP_Menu_SetDefaultBorderSize (I32 idx, U8 BorderSize)
{
	if ((idx >= TP_MENU_BORDER_INDEX_MIN) && (idx < TP_MENU_BORDER_INDEX_MAX))
	{
