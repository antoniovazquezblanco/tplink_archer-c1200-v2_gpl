...
static GUI_CONST_STORAGE unsigned long _acKB_CharGuideBmp[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmKB_CharGuideBmp = {
  60, // xSize
  28, // ySize
  240, // BytesPerLine
  32, // BitsPerPixel
  (unsigned char *)_acKB_CharGuideBmp,  // Pointer to picture data
