...
uint8_t BSP_LCD_Init(void)
{
  ...
  /*if(ili9341_drv.ReadID() == ILI9341_ID)*/
    ...
    LtdcHandler.Init.HorizontalSync = 1;
    /* Configure vertical synchronization height */
    LtdcHandler.Init.VerticalSync = 1;
    /* Configure accumulated horizontal back porch */
    LtdcHandler.Init.AccumulatedHBP = 43;
    /* Configure accumulated vertical back porch */
    LtdcHandler.Init.AccumulatedVBP = 12;
    /* Configure accumulated active width */
    LtdcHandler.Init.AccumulatedActiveW = 603;
    /* Configure accumulated active height */
    LtdcHandler.Init.AccumulatedActiveH = 333;
    /* Configure total width */
    LtdcHandler.Init.TotalWidth = 605;
    /* Configure total height */
    LtdcHandler.Init.TotalHeigh = 335;
    ...
    /* LTDC clock frequency = PLLLCDCLK / LTDC_PLLSAI_DIVR_8 = 36/4 = 9Mhz */
    ...
    /* Select the device */
    LcdDrv = &LcdKd43g20_drv;//ili9341_drv;//
